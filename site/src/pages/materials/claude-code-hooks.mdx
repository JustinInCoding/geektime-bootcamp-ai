...
## 📊 Claude Code Hooks 核心数据

export const hooksMetrics = [
  { label: 'Hook 事件类型', value: 9, color: '#b3272c', icon: '🎯' },
  { label: 'Hook 类型', value: 2, color: '#772d8b', icon: '⚙️' },
  { label: '配置层级', value: 3, color: '#77a0a9', icon: '📁' },
  { label: '通信方式', value: 2, color: '#d3f9b5', icon: '🔌' },
  { label: '安全检查项', value: 6, color: '#f5cbc5', icon: '🛡️' },
  { label: '最佳实践条数', value: 12, color: '#772d8b', icon: '✅' }
]

<MetricCard title="Claude Code Hooks 数据概览" items={hooksMetrics} type="number" client:load />
